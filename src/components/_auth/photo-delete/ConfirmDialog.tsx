  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 -translate-1/2 flex flex-col gap-6 justify-between p-4 rounded-base shadow-lg z-80 bg-base-100 will-change-auto data-[state=open]:animate-modal-in">
          <Dialog.Title className="font-body-base text-base-700">
          ...
          <div className="flex items-center justify-end gap-3 *:py-2 *:px-4 *:cursor-pointer *:rounded-base *:font-body-base *:text-base-700">
            <Dialog.Close className="bg-interactive-200">Cancelar</Dialog.Close>
            <Dialog.Close
